...
const METRIC_DEFS = {
    ...
    distance: {
        ...
        i18nKey: 'sensor_distance',
        csvHeader: 'Distance (cm)',
        csvPrecision: 0,
        cardId: 'distance-card',
        valueId: 'distance-value',
        sparklineId: 'distance-sparkline',
    },
    variance: {
        key: 'variance',
        label: 'Variance',
        ...
        i18nKey: 'sensor_variance',
        csvHeader: 'Variance',
        csvPrecision: 1,
        cardId: 'variance-card',
        valueId: 'variance-value',
        sparklineId: 'variance-sparkline',
    },
...
const EXTRA_FIELD_DEFS = {
    ...
    presencePct:        { key: 'presencePct',          csvHeader: 'Presence (%)',           csvPrecision: 0 },
