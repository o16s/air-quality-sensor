...
import { updateSpectralChart, setSpectralLoading, redrawSpectralChart } from './liveSpectral.js';

// Re-export spectral functions for existing consumers
export { setSpectralLoading, redrawSpectralChart };
