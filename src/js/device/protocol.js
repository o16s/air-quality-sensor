 ...
 * Handles USB vendor requests and control transfers for Octanis ICS.
 * Binary parsing is delegated to parsers.js.
 */
...
import {
    ...
    parseStatusDataTSL,
    parseStatusDataCO2,
    parseStatusDataRadar,
    parseStatusDataSpectral,
    parseLogItem,
    parseLogItemTSL,
    parseLogItemCO2,
    parseLogItemRadar,
    parseLogItemSpectral,
} from './parsers.js';
