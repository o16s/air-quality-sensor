 ...
 * Matches on exact timestamp + deviceSerial — device timestamps are
 * reliable, so fuzzy matching is unnecessary and risks false positives.
 *
...
export function isDuplicateLog(newLog, existingLog) {
    ...
    return newLog.timestamp === existingLog.timestamp;
}
